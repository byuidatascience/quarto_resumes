...
projects = pl.read_parquet(dfolder + "/projects.parquet")
skills = pl.read_parquet(dfolder + "/skills.parquet")
work = pl.read_parquet(dfolder +"/work.parquet")
education = pl.read_parquet(dfolder + "/education.parquet")
contact = pl.read_parquet(dfolder + "/contact.parquet")
